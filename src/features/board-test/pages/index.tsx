...
import { MessageCircle, MoreHorizontal, SearchIcon } from 'lucide-react';
...
const INITIAL_LEADS: MockLead[] = [
  { id: '1',  name: 'Rafael Souza',     cpf: '123.456.789-00', phone: '(11) 91234-5678', stage: 'new-lead' },
  { id: '2',  name: 'Mariana Lima',     cpf: '987.654.321-00', phone: '(21) 99876-5432', stage: 'new-lead' },
  { id: '3',  name: 'Carlos Pereira',   cpf: '111.222.333-44', phone: '(31) 98765-4321', stage: 'new-lead' },
  { id: '4',  name: 'Ana Oliveira',     cpf: '222.333.444-55', phone: '(41) 97654-3210', stage: 'negotiation' },
  { id: '5',  name: 'Roberto Costa',    cpf: '333.444.555-66', phone: '(51) 96543-2109', stage: 'negotiation' },
  { id: '6',  name: 'Juliana Ferreira', cpf: '444.555.666-77', phone: '(61) 95432-1098', stage: 'proposal' },
  { id: '7',  name: 'Pedro Martins',    cpf: '555.666.777-88', phone: '(71) 94321-0987', stage: 'proposal' },
  { id: '8',  name: 'Beatriz Alves',    cpf: '666.777.888-99', phone: '(81) 93210-9876', stage: 'sale' },
  { id: '9',  name: 'Lucas Rodrigues',  cpf: '777.888.999-00', phone: '(11) 92109-8765', stage: 'sale' },
  { id: '10', name: 'Fernanda Santos',  cpf: '888.999.000-11', phone: '(21) 91098-7654', stage: 'follow-up' },
  { id: '11', name: 'Gustavo Cardoso',  cpf: '999.000.111-22', phone: '(31) 90987-6543', stage: 'follow-up' },
  { id: '12', name: 'Larissa Mendes',   cpf: '000.111.222-33', phone: '(41) 98876-5432', stage: 'disqualified' },
  { id: '13', name: 'Thiago Rocha',     cpf: '111.333.555-77', phone: '(51) 97765-4321', stage: 'disqualified' },
];
...
export function BoardTestPage() {
  ...
  const handleDrop = (itemId: string, columnId: string) => {
    setLeads(prev =>
      prev.map(lead => lead.id === itemId ? { ...lead, stage: columnId } : lead)
    );
  };
        ...
        {STAGES.map(stage => {
          ...
          return (
            <BoardColumn key={stage.id} id={stage.id} onDrop={handleDrop}>
              <BoardColumnHeader title={stage.label} count={stageLeads.length} />
      ...
      <Sheet open={!!sheetLead} onOpenChange={(open) => !open && setSheetLead(null)}>
        <SheetContent>
          ...
          <div className="mt-6 flex flex-col gap-3">
            <p className="text-sm text-muted-foreground">Ações disponíveis para este lead:</p>
            <Button variant="outline" className="justify-start">Editar informações</Button>
            <Button variant="outline" className="justify-start">Criar simulação</Button>
            <Button variant="outline" className="justify-start">Registrar atividade</Button>
